class characterStats:  # specify's dandilions abilty scores and creates values for them.
    def __init__(self, name, str=13, dex=14, con=13, int=14, wis=13, cha=14, ):
        ...
        self.SD = {'Acrobatics': ['dex', False],
                   # Dictionary for  functions to pull up skills and if Dandlion is trained
        ...
        self.spells = {'cure wounds': [
            'Instantaneous spell at touch range. "']}  # creature i touch regains a number of hit points = to 1D8 + my spell casting ability modifier. Increase by 1D8 for each slot level above 1st"', '1st level spell'],
